...
import barakat from '../assets/Component 2.png';
...
const Hero =() => {
    ...
    return(
        <div id='hero-section' className="flex flex-col  md:pt-24 md:flex-row justify-between z-10">
            ...
            <div className="p-4 md:p-16 w-full text-[#000]">
                ...
                <p className="my-4 w-full text-justify p-4">Hi, I'm Barakat, a passionate Frontend Developer with a knack for turning ideas into interactive, 
            ...
            <div className="px-8 w-full mx-auto justify-center place-content-center bg-purple-900/25 ">
            <Background/>
