...
const Hero =() => {
    ...
    return(
        <div className="flex flex-col lg:flex-row">
            ...
            <div className="p-10 lg:p-20 bg-lavender text-lumber w-full lg:w-2/3">
                <h1 className="text-6xl font-bold"><span className="text-white">Front</span>End</h1>
                <h1 className="text-6xl font-bold text-cotton-candy">Developer.</h1>
                <p className="my-5 lg:w-1/2 w-full text-justify">Hi, I'm Barakat, a passionate Frontend Developer with a knack for turning ideas into interactive, 
            ...
            <div className="p-10 lg:p-10 w-full mx-auto justify-center lg:w-1/3 bg-thistle lg:relative">
