...
const ContactForm = () => {
    const [state, handleSubmit] = useForm("mgvvwbrp");
    if (state.succeeded) {
        return( <p className='flex justify-center text-2xl my-auto w-full h-full text-pink-700 font-semibold'>Thanks for reaching out!</p>);
    }
  return (
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="mail" name="email" id="email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
